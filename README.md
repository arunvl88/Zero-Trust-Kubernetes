...
## Note: Pod Restart: When a pod restarts, for any reason (e.g., due to a crash, update, or manual deletion and recreation), it will typically be assigned a new IP address by the Kubernetes network plugin.
